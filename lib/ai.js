// lib/ai.js
// 目的：使用通用的 OpenAI SDK 兼容 Zhipu AI (智谱/GLM) API 地址。

import { OpenAI } from 'openai'; 

// --- Zhipu AI / GLM 配置常量 ---
// 修改：从 Vercel 环境变量中获取 GLM_API_KEY (原代码为 ZHIPU_API_KEY)
const ZHIPU_API_KEY = process.env.GLM_API_KEY;

// 修改：优先使用 GLM_BASE_URL，如果未设置则使用默认地址
